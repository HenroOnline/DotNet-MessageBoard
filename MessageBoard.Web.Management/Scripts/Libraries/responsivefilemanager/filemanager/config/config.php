...
$upload_dir = '/content/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../content/'; // relative path from filemanager folder to upload folder (with final /)
